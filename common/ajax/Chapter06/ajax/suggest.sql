...
INSERT INTO suggest (name) VALUES 
  ...
  ('sdo_das_xml_document_getencoding'),
  ('sdo_das_xml_document_getnonamespaceschemalocation'),
  ('sdo_das_xml_document_getrootdataobject'),
  ('sdo_das_xml_document_getrootelementname'),
  ('sdo_das_xml_document_getrootelementuri'),
  ('sdo_das_xml_document_getschemalocation'),
  ('sdo_das_xml_document_getxmldeclaration'),
  ('sdo_das_xml_document_getxmlversion'),
  ('sdo_das_xml_document_setencoding'),
  ('sdo_das_xml_document_setnonamespaceschemalocation'),
  ('sdo_das_xml_document_setschemalocation'),
  ('sdo_das_xml_document_setxmldeclaration'),
  ('sdo_das_xml_document_setxmlversion'),
  ('sdo_das_xml_loadfromfile'),
  ('sdo_das_xml_loadfromstring'),
  ('sdo_das_xml_savedataobjecttofile'),
  ('sdo_das_xml_savedataobjecttostring'),
  ('sdo_das_xml_savedocumenttofile'),
  ('sdo_das_xml_savedocumenttostring'),
  ('sdo_datafactory_create'),
  ('sdo_dataobject_clear'),
  ('sdo_dataobject_createdataobject'),
  ('sdo_dataobject_getcontainer'),
  ('sdo_dataobject_getcontainmentpropertyname'),
  ('sdo_dataobject_getsequence'),
  ('sdo_dataobject_gettype'),
  ('sdo_list_insert'),
  ('sdo_sequence_getpropertyindex'),
  ('sdo_sequence_getpropertyname'),
  ('sdo_sequence_insert'),
  ('sdo_sequence_move'),
  ('sem_acquire'),
  ('sem_get'),
