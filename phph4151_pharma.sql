...
--
-- Host: localhost
-- Generation Time: Jul 03, 2011 at 09:53 AM
...
('f21e7c36e8b0e79289bb7c72cc3313e9', '202.124.88.173', 'Mozilla/5.0 (Windows NT 6.1; rv:2.0.1) Gecko/20100', 1309519417, ''),
('39b077d601d98f991baf1e9b23498579', '208.80.194.36', 'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1;', 1309548444, ''),
('6102ef10e2e96625abdb2f46cc9c619d', '66.249.67.145', 'Mozilla/5.0 (compatible; Googlebot/2.1; +http://ww', 1309614572, ''),
('9c597f77113b05656d5ac366fbc7a97a', '66.249.67.227', 'Mozilla/5.0 (compatible; Googlebot/2.1; +http://ww', 1309701075, '');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Stores the medicines' AUTO_INCREMENT=43 ;
...
CREATE TABLE IF NOT EXISTS `medicine_salt` (
  ...
  KEY `salt_id` (`salt_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Links the medicines with their salts FK-FK table' AUTO_INCREMENT=47 ;
...
CREATE TABLE IF NOT EXISTS `medicine_types` (
  ...
  `updated_at` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Stores the medicine types, like pills,syrup etc' AUTO_INCREMENT=11 ;
...
CREATE TABLE IF NOT EXISTS `salts` (
  ...
  `updated_at` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Stores the medicine salts, like PARACETAMOL' AUTO_INCREMENT=38 ;
